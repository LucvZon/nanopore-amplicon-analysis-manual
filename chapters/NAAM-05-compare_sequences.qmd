# 4. Manual: Sequence Comparison {.unnumbered}
...
::: {.callout-note}
As an optional step you can move on to the next chapter and run Nextclade for your generated consensus sequences. 
:::