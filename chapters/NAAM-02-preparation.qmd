...
``` bash
wget https://github.com/LucvZon/nanopore-amplicon-analysis-manual/releases/download/v1.1.1/naam_workflow.sif
```

Or go to the [github page](https://github.com/LucvZon/nanopore-amplicon-analysis-manual/releases/tag/v1.1.1){target="_blank"} and manually download it there, then transfer it to your HPC system.
